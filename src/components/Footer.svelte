<footer class="bg-card-gray text-text-gray px-20 flex flex-col gap-6 p-10 align-middle items-center">
    <div>
	<a href="/home"><img src="assets/sekiaLogo.png" alt="" /></a>
    </div>
    <hr class="w-full" color="#A1A1A6">
